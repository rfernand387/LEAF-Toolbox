...
var addL08Geometry = function(colOptions,image) {
  ...
  return image.addBands(geometryBands.select([colOptions.get('vza'),colOptions.get('sza')]).divide(1000).multiply(3.1415).divide(180).cos().multiply(1000).toUint16().rename('cosVZA','cosSZA'))
              .addBands(geometryBands.select([colOptions.get('vaa')]).subtract(geometryBands.select([colOptions.get('saa')])).divide(1000).multiply(3.1415).divide(180).cos().multiply(1000).toUint16().rename('cosRAA'))
}      
