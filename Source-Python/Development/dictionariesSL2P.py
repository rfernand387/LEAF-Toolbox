...
def make_collection_options(fc): 
    ...
    COLLECTION_OPTIONS = {
        ...
        "Collection_estimates": ee.FeatureCollection(fc.s2_createCollection_estimates()),
        "Collection_errors": ee.FeatureCollection(fc.s2_createCollection_errors()),  
        "Domain": ee.FeatureCollection(fc.s2_createCollection_domains()),
        "Network_Ind": ee.FeatureCollection(fc.s2_createCollection_Network_Ind()),
        "partition": ee.ImageCollection(fc.s2_createImageCollection_partition()),
        "legend": ee.FeatureCollection(fc.s2_createCollection_legend()),
        "numVariables": 7,
        "exportRes": 20,
        "tools": toolsS2
        },
        ...
        "vaa": 'MEAN_INCIDENCE_AZIMUTH_ANGLE_B8A',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "Collection_estimates": ee.FeatureCollection(fc.s2_10m_createCollection_estimates()),
        "Collection_errors": ee.FeatureCollection(fc.s2_10m_createCollection_errors()),  
        "Domain": ee.FeatureCollection(fc.s2_10m_createCollection_domains()),
        "Network_Ind": ee.FeatureCollection(fc.s2_10m_createCollection_Network_Ind()),
        "partition": ee.ImageCollection(fc.s2_10m_createImageCollection_partition()),
        "legend": ee.FeatureCollection(fc.s2_10m_createCollection_legend()),
        "numVariables": 7,
        "exportRes": 10,
        "tools": toolsHLS
        },
        ...
        "vaa": 'VAA',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "Collection_estimates": ee.FeatureCollection(fc.l8_createCollection_estimates()),
        "Collection_errors": ee.FeatureCollection(fc.l8_createCollection_errors()),
        "Domain": ee.FeatureCollection(fc.l8_createCollection_domains()),
        "Network_Ind": ee.FeatureCollection(fc.l8_createCollection_Network_Ind()),
        "partition": ee.ImageCollection(fc.l8_createImageCollection_partition()),
        "legend": ee.FeatureCollection(fc.l8_createCollection_legend()),
        "numVariables": 7,
        "exportRes": 30,
        "tools": toolsL8
        },
        ...
        "vaa": 'VAA',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "Collection_estimates": ee.FeatureCollection(fc.l9_createCollection_estimates()),
        "Collection_errors": ee.FeatureCollection(fc.l9_createCollection_errors()),
        "Domain": ee.FeatureCollection(fc.l9_createCollection_domains()),
        "Network_Ind": ee.FeatureCollection(fc.l9_createCollection_Network_Ind()),
        "partition": ee.ImageCollection(fc.l9_createImageCollection_partition()),
        "legend": ee.FeatureCollection(fc.l9_createCollection_legend()),
        "numVariables": 7,
        "exportRes": 30,
        "tools": toolsL9
        },
