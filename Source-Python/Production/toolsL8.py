...
def addGeometry(colOptions,image):
  ...
  image.addBands(geometryBands.select([colOptions.vza,colOptions.sza]).divide(1000).multiply(3.1415).divide(180).cos().multiply(10000).toUint16().rename('cosVZA','cosSZA')) \
