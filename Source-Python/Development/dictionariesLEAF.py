...
def make_collection_options(fc): 
    ...
    COLLECTION_OPTIONS = {
        ...
        "estimators": ee.FeatureCollection(fc.s2_createFeatureCollection_estimates()),
        "errors": ee.FeatureCollection(fc.s2_createFeatureCollection_errors()),  
        "domain": ee.FeatureCollection(fc.s2_createFeatureCollection_domains()),
        ...
        "filterCollection": fc.filterCollCollection(),
        "makeEstimator": fc.makeNets(),
        "numVariables": 7,
        "exportRes": 20,
        "tools": toolsS2
        },
        ...
        "vaa": 'MEAN_INCIDENCE_AZIMUTH_ANGLE_B8A',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "estimators": ee.FeatureCollection(fc.s2_10m_createFeatureCollection_estimates()),
        "errors": ee.FeatureCollection(fc.s2_10m_createFeatureCollection_errors()),  
        "domain": ee.FeatureCollection(fc.s2_10m_createFeatureCollection_domains()),
        ...
        "vaa": 'VAA',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "estimators": ee.FeatureCollection(fc.l8_createFeatureCollection_estimates()),
        "errors": ee.FeatureCollection(fc.l8_createFeatureCollection_errors()),
        "domain": ee.FeatureCollection(fc.l8_createFeatureCollection_domains()),
        ...
        "vaa": 'VAA',
        "VIS_OPTIONS": 'VIS_OPTIONS',
        "estimators": ee.FeatureCollection(fc.l9_createFeatureCollection_estimates()),
        "errors": ee.FeatureCollection(fc.l9_createFeatureCollection_errors()),
        "domain": ee.FeatureCollection(fc.l9_createFeatureCollection_domains()),
